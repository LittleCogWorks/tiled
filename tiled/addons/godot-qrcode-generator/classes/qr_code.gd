...
const UTILS_SCRIPT = preload("res://addons/godot-qrcode-generator/classes/utils.gd")
const REED_SOLOMON_GENERATOR_SCRIPT = preload("res://addons/godot-qrcode-generator/classes/reed_solomon_generator.gd")
